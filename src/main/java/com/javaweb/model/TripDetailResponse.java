...
public class TripDetailResponse {
    ...
    public Integer getTotal_seat() { return total_seat; }
    public void setTotal_seat(Integer total_seat) { this.total_seat = total_seat; }

    public List<String> getOrdered_seat() {
        return ordered_seat == null ? List.of() : ordered_seat;
    }
