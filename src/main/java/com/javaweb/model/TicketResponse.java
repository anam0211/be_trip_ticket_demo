...
public class TicketResponse {
    ...
    public Instant getCreated_time() { return created_time; }
    public void setCreated_time(Instant created_time) { this.created_time = created_time; }
    ...
    public Leg getOutbound() { return outbound; }
    public void setOutbound(Leg outbound) { this.outbound = outbound; }

    public Leg getReturnTrip() { return returnTrip; }
    public void setReturnTrip(Leg returnTrip) { this.returnTrip = returnTrip; }
    ...
    public static class Leg {
        ...
        public Integer getCoach_id() { return coach_id; }
        public void setCoach_id(Integer coach_id) { this.coach_id = coach_id; }
        ...
        public List<String> getOrdered_seat() { return ordered_seat; }
        public void setOrdered_seat(List<String> ordered_seat) { this.ordered_seat = ordered_seat; }
